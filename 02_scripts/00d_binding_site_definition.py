...
Reads campaign_config.yaml:
    - grids.binding_site.method          -> residues | coordinates | reference_ligand
    - grids.binding_site.residues        -> lista de residuos (primary method)
    - grids.binding_site.center          -> coordenadas (alternative method)
    - grids.binding_site.reference_mol2  -> ligando de referencia (legacy, still supported)
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("  HIT_VALIDATION - Module 00d: Binding Site Definition")
    logger.info("=" * 60)
