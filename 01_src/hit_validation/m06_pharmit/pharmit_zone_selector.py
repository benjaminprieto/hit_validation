...
Input:
    ...
    Optional: residue_consensus.csv (from hit_validation 04b)
...
Location: 01_src/hit_validation/m06_pharmit/pharmit_zone_selector.py
...
<div class="footer">hit_validation | Module 06b | Pharmit Zone Selector v3.1 (evidence) | {datetime.now().strftime('%Y-%m-%d %H:%M')}</div>
</body></html>"""
