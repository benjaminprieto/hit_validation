...
docked pose against a reference ligand and the receptor,
...
Location: 01_src/hit_validation/m04_dock6_analysis/footprint_rescoring.py
...
from hit_validation.m01_docking.dock6_runner import (
    find_dock6_params,
    run_dock6_single,
    _create_symlink,
)
...
def generate_footprint_rescore_input(
    ...
    Args:
        ...
        reference_mol2: Reference ligand mol2 (e.g., best scored pose)
